...
from enterprise_extensions.timing_2 import (timing_block,filter_Mmat)
...
def model_general(
    ...
    if not tm_var:
        ...
        if tm_linear and not nltm_plus_ltm:
            ...
            psrs2 = [filter_Mmat(psr,ltm_exclude_list=ltm_exclude_list,exclude=exclude) for psr in psrs]
