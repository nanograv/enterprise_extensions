...
def Dropout_PhysicalEphemerisSignal(
    ...
    jup_mjd, jup_orbelxyz, sat_orbelxyz = (
    ...
    if not tm_var:
        if is_wideband and use_dmdata:
            ...
            if white_vary:
                ...
                #dmjump = parameter.Constant()
            s = gp_signals.WidebandTimingModel(dmefac=dmefac, dmjump=dmjump,
...
def model_general(psrs, tm_var=False, tm_linear=False, tmparam_list=None,
                  ...
                  noisedict=None, white_vary=False, tm_svd=False, tm_norm=True,
